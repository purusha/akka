...
public class StartSystem {
	...
	public static void main(String[] args) throws Exception {
		...
		final MultiDomainRequest req = new MultiDomainRequest(new String[] { "facebook.com", "vk.com", "badoo.com",
				"yahoo.com", "techcrunch.com", "akka.io", "github.com" });
	...
	static class MasterActor extends UntypedActor {
		...
		public void onReceive(Object message) throws Exception {
			if (message instanceof MultiDomainRequest) {
				...
				final Future<String> transformed = aggregate.map(new Mapper<Iterable<Object>, String>() {
	...
	static class GooglePageRankActor extends UntypedActor {
		...
		private String buildUrl(final String domain) {
			...
			final String url = "http://toolbarqueries.google.com/tbr?client=navclient-auto&hl=en&" + "ch=6" + hash
